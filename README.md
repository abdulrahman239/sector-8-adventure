...
- Rehan (Role 1 — State Management)
- Raki (Role 1 — Main / Game Loop)
- Nithin (Role 2 — Story & NPCs)
- Nawaf (Role 2 — Inventory)
- Sami (Role 3 — Security, Save/Load)
- Bader (Role 3 — Challenges)
...
2. **The Ghost in the Wire** — Escape through the security checkpoint after hacking the terminal
